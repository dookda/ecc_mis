...
var L68 = 'https://eec-onep.online/geoserver/eec/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=eec%3Aa__68_complaint_pollu_cco&maxFeatures=50&outputFormat=application%2Fjson';
var L69 = 'https://eec-onep.online/geoserver/eec/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=eec%3Aa__69_complaint_pollu_cbi&maxFeatures=50&outputFormat=application%2Fjson';
var L70 = 'https://eec-onep.online/geoserver/eec/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=eec%3Aa__70_complaint_pollu_ryg&maxFeatures=50&outputFormat=application%2Fjson';
$(document).ready(() => {
    loadTable()
    layermark(L68, 68)
    layermark(L69, 69)
...
const pollucco = L.tileLayer.wms("https://eec-onep.online/geoserver/eec/wms?", {
    layers: 'eec:a__68_complaint_pollu_cco',
    format: 'image/png',
    transparent: true
});
const pollucbi = L.tileLayer.wms("https://eec-onep.online/geoserver/eec/wms?", {
    layers: 'eec:a__69_complaint_pollu_cbi',
    format: 'image/png',
    transparent: true
});
const polluryg = L.tileLayer.wms("https://eec-onep.online/geoserver/eec/wms?", {
