...
legend.onAdd = function (map) {
    ...
    div.innerHTML += '<img src="./Mark.png" width="10px"><span>ตำแหน่งนำเข้าข้อมูล</span><br>';
    return div;
};
legend.addTo(map);
