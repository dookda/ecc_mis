...
function showB() {
    ...
    axios.get(dataurl).then((r) => {
        ...
        dataB = [
            { "type_name": "ไก่", "value": dataB1.length },
            { "type_name": "เป็ด", "value": dataB2.length },
            { "type_name": "หมู", "value": dataB3.length },
            { "type_name": "วัว", "value": dataB4.length },
            { "type_name": "ควาย", "value": dataB5.length },
            { "type_name": "อื่นๆ", "value": dataB6.length }
