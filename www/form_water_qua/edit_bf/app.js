...
let loadData = () => {
    ...
    axios.post(url + "/wq-api/getone", obj).then(r => {
        ...
        $('#wq_turb').val(r.data.data[0].wq_turb)
        $('#wq_cond').val(r.data.data[0].wq_cond)
        $('#wq_sal').val(r.data.data[0].wq_sal)
        $('#wq_tds').val(r.data.data[0].wq_tds)
        $('#wq_ph').val(r.data.data[0].wq_ph)
        $('#wq_bod').val(r.data.data[0].wq_bod)
        $('#wq_cod').val(r.data.data[0].wq_cod)
        $('#wq_ss').val(r.data.data[0].wq_ss)
        $('#wq_ses').val(r.data.data[0].wq_ses)
        $('#wq_do').val(r.data.data[0].wq_do)
        $('#wq_temp').val(r.data.data[0].wq_temp)
        $('#wq_og').val(r.data.data[0].wq_og)
        $('#wq_tkn').val(r.data.data[0].wq_tkn)
        $('#wq_tn').val(r.data.data[0].wq_tn)
        $('#wq_tp').val(r.data.data[0].wq_tp)
        $('#wq_fcb').val(r.data.data[0].wq_fcb)
        $('#wq_tcb').val(r.data.data[0].wq_tcb)
